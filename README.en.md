...
> 🇷🇺 **Russian original (source of truth):** [`README.md`](README.md). Deep theory docs are in Russian.
>
> 🤖 **For AI agents:** context, glossary, and working rules are in [`AGENTS.en.md`](AGENTS.en.md) / [`AGENTS.md`](AGENTS.md). Terminology is locked in [`GLOSSARY.md`](GLOSSARY.md).
...
| File | Contents |
|------|----------|
| [`AGENTS.en.md`](AGENTS.en.md) / [`AGENTS.md`](AGENTS.md) | Context & rules for AI agents (EN / RU) |
...
> Deep theory docs are in Russian (source of truth). AI agents read Russian natively; for English use the locked terms in `GLOSSARY.md`.
